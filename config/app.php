...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '46fdb2c2acbea6e347e36639c74d10f84c6a32267394473e5c07f09cba9ce508'),                                        
        'csrfProtection' => true,
    ],
    ...
    'EmailTransport' => [
        ...
        'default' => [ // WOKKS!!!!!!!! 
            ...
            'host' => 'smtp.truckzone.com.br',
            'port' => 587,
            'username' => 'nao-responder@truckzone.com.br',
            'password' => '#Endor123#',
            'className' => 'Smtp',
            //'tls' => true,
            'log' => true,
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'nao-responder@truckzone.com.br',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'postgres',
            'password' => '123456',
            'database' => 'seu_caminhao',*/

            'host' => 'truck_zone.postgresql.dbaas.com.br',
            'username' => 'truck_zone',
            'password' => 'Endor#1V3t1r#',
            'database' => 'truck_zone',
