	CREATE TABLE users (
		...
		commercial_number  VARCHAR(255)  NULL,			    
	    date_of_birth      DATE NOT NULL,
	    cpf                VARCHAR(127) NULL,
		cnpj               VARCHAR(127) NULL,
		active             BOOLEAN, -- Usuario cadastrado no sistema, se excluido, false, else if true
		otp				   VARCHAR(50) NOT NULL,	-- Usado para verificar se o email é válido
		status             VARCHAR(50) NOT NULL,   -- Usado para verificar se o email é válido
	...
	CREATE TABLE validated_user_states (
	...
	CREATE TABLE validated_users (
		...
		id      SERIAL PRIMARY KEY,		
		user_id INTEGER NOT NULL,		
		validated_user_state_id INTEGER NOT NULL,
	    created TIMESTAMP DEFAULT NULL,
	    modified TIMESTAMP DEFAULT NULL
	...
	CREATE TABLE addresses  (
		...
		user_id                    INTEGER NOT NULL,  -- Estado
		state_id                   INTEGER NULL,  -- Estado
		city_id                    INTEGER NULL,  -- Cidade
		address_street          VARCHAR(120) NULL, -- Rua
		address_number          VARCHAR(10) NULL,  -- Número
		address_complement      VARCHAR(70) NULL,  -- Complemento
		address_district        VARCHAR(50) NULL, -- Bairro
		address_zip_code        VARCHAR(15) NULL, -- CEP
	...
	CREATE TABLE ads  (
		...
		payment_received_code INTEGER NULL,
		number_of_views  INTEGER NULL,
	...
	CREATE TABLE ad_plans  (
		...
		free         BOOLEAN NOT NULL,
		value    REAL NOT NULL,				
		max_number_cars INTEGER NOT NULL,
	...
	INSERT INTO countries (name,alias,created,modified) VALUES ('Brasil','brasil',now(),now())

	INSERT INTO states (id,name,alias,country_id) VALUES
	(1, 'Acre', 'AC', 1),
	(2, 'Alagoas', 'AL', 1),
	(3, 'Amazonas', 'AM', 1),
	(4, 'Amapá', 'AP', 1),
...
--Roles (admin,editor,validador,representante, lojista,autonomo)
INSERT INTO roles(name,alias) VALUES ('Administrador','admin');          -- 1 
INSERT INTO roles(name,alias) VALUES ('Editor','editor');                -- 2
INSERT INTO roles(name,alias) VALUES ('Validador','validador');          -- 3 
INSERT INTO roles(name,alias) VALUES ('Representante','representante');  -- 4 
INSERT INTO roles(name,alias) VALUES ('Logista','lojista');              -- 5 
INSERT INTO roles(name,alias) VALUES ('Individual','individual');            -- 6 
-- Permissions
INSERT INTO permissions(user_id,role_id) VALUES (1,1);
INSERT INTO permissions(user_id,role_id) VALUES (1,2);
INSERT INTO permissions(user_id,role_id) VALUES (1,3);
INSERT INTO permissions(user_id,role_id) VALUES (1,4);
INSERT INTO permissions(user_id,role_id) VALUES (1,5);
INSERT INTO permissions(user_id,role_id) VALUES (1,6);

INSERT INTO ad_states(name,alias) VALUES ('Ativo','ativo');
INSERT INTO ad_states(name,alias) VALUES ('Pausado','pausado');
INSERT INTO ad_states(name,alias) VALUES ('Expirado','expirado');
INSERT INTO ad_states(name,alias) VALUES ('Pendente','pendente');
INSERT INTO ad_states(name,alias) VALUES ('Negado','negado');

INSERT INTO truck_types(name,alias) VALUES ('Vans','vans');
INSERT INTO truck_types(name,alias) VALUES ('Ônibus','onibus');
INSERT INTO truck_types(name,alias) VALUES ('Caminhões','caminhoes');


INSERT INTO users(email,password,name,mobile_number,date_of_birth,cpf,active,otp,status)
          VALUES ('vtrpb@hotmail.com','$2y$10$ybCMi9HJ8S3F.Bha42DoeuDQyRqwmjBHZNQozXWmmRhESFyJys0aC','VINÍCIUS TOSCANO ROCHA','(83)98811-4138','1983-05-28','042.367.864-78',true,'','ativo');