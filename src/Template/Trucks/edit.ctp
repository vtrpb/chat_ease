...
<script language="javascript" type="text/javascript">
  ...
  $(document).ready(function () {      
    ...
    //$('#mileage').mask('000.000.000 km', {reverse: true});
                ...
                <div class="card card-danger">
                        <?= $this->Form->create($truck,['id'=>'form-template','class'=>'form-horizontal']) ?>                        
                            <?php                              
                                ...
                                echo "</div>";                               
                                echo "<div class=\"row\">";                                    
                                    echo "<div class=\"col-md-3\">" . $this->Form->control('truck_type_id',['label'=>'Tipo de Veículo','options'=>$truckTypes,'div' => false,'class' => 'form-control','readonly'=>'readonly'])."</div>";
                                    ...
                                    echo "<div class=\"col-md-3\">" . $this->Form->control('city_id',['label'=>'Cidade','required'=>true,'options'=>$cities,'div' => false,'class' => 'form-control select2 city-id',])."</div>";
                                echo "</div>";

                                echo "<div class=\"row\">";                                                                        
                                    echo "<div class=\"col-md-3\">" .$this->Form->control('brand', ['label' => 'Marca','required'=>true,'class' => 'form-control','readonly'=>'readonly']) . "</div>";
                                    echo "<div class=\"col-md-3\">" . $this->Form->control('model',['label'=>'Modelo','required'=>true,'class' => 'form-control','readonly'=>'readonly'])."</div>";
                                    echo "<div class=\"col-md-3\">" . $this->Form->control('year',['label'=>'Ano','required'=>true,'class' => 'form-control','readonly'=>'readonly'])."</div>";                             
                                    echo "<div class=\"col-md-3\">" . $this->Form->control('mileage',['label'=>'Quilometragem','required'=>true,'type'=>'text','div' => 'false','class' => 'form-control'])."</div>";
                                echo "</div>";
