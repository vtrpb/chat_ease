        ...
        <div class="row">
          <div class="col-md-12">                
                <div class="card card-danger">
                        <?= $this->Form->create($truckType,['id'=>'form-template','class'=>'form-horizontal']) ?>                        
                            <?php                              
                                echo "<div class=\"card-body\">";        
                              
                                echo "<div class=\"row\">";                                    
                                    echo "<div class=\"col-6\">" . $this->Form->control('name',['label'=>'Nome','type'=>'text','div' => 'false','class' => 'form-control'])."</div>";                                    
                                    echo "<div class=\"col-6\">" . $this->Form->control('alias',['label'=>'Abreviatura','type'=>'text','div' => 'false','class' => 'form-control'])."</div>";
                                echo "</div>";                                                     
