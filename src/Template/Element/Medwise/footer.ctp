                    ...
                    <div class="col-lg-4">
                        <div class="widget widget-about">           <!-- Widget -->
                            ...
                            <ul class="social social-round social-2x">
                                ...
                                <li><a class="linkedin" href="https://www.linkedin.com/company/truckzone" target="_blank"><i class="ion-logo-linkedin"></i></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-10 mb-10 text-right">
                        <p class="mb-0 footer-text text-lg-right text-center">&copy; <?= date('Y')?> - Desenvolvido por <a href="https://api.whatsapp.com/send?phone=83988114138">Endor Tecnologia</a>
