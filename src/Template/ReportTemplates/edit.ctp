...
<script>
    ...
    var report_template = '<?= $reportTemplate->template ?>';

    $(document).ready(function ($) {        

        report_editor.setData(report_template);
    ...
    <div class="content-header">
      <div class="container-fluid">                            
        <ul class="breadcrumb">
            ...
            <li> <strong> / </strong></li>
            <li>EDITANDO MODELO DE DOCUMENTO</li>
        </ul>                        
      </div>
    </div>
    <!-- /.content-header -->
                            ...
                            <?php                              
                                echo "<div class=\"card-body\">";                                
                                 ...
                                 echo "<div class=\"row\">";                                    
                                    ...
                                    echo "<div class=\"row\">";                                    
                                        echo "<div class=\"col-8\">" . $this->Form->control('sector_id', ['label'=>'Setor','options' => $sectors, 'empty' => '(selecione o Setor)','selected'=>'selected','class'=>'form-control'])."</div>";
                                    echo "</div>";                                    
