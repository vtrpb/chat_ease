                        ...
                        <?= $this->Form->create($core,['id'=>'form-template','class'=>'form-horizontal']) ?>                        
                            <?php                              
                                echo "<div class=\"card-body\">";                                
                                  ...
                                  echo "<div class=\"row\">";                                    
                                    echo "<div class=\"col-8\">".$this->Form->control('sector_id', ['label'=>'Setor','options'=>$sectors,'required' => true,'div' => false,'class'=>'form-control'])."</div>";                                        
                                  echo "</div>";

                                  echo "<div class=\"row\">";                                    
                                    echo "<div class=\"col-8\">".$this->Form->control('subsector_id', ['label'=>'Subsetor','options'=>$subsectors,'required' => true,'div' => false,'class'=>'form-control'])."</div>";                                        
                                  echo "</div>";

                                  echo "<div class=\"row\">";                                    
                                    echo "<div class=\"col-8\">".$this->Form->control('name', ['label'=>'Nome do Núcleo','type'=>'text','required' => true,'div' => false,'class'=>'form-control'])."</div>";                                        
                                  echo "</div>";
