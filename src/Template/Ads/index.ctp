                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions text-nowrap">                                        
                                        ...
                                        <?= $this->Html->link('<button type="button" class="btn btn-primary btn-sm nav-icon fas fa-eye"  title="ANÚNCIO"></button>',['controller'=>'Site','action' => 'viewAd',$ad->id],['escape' => false,'target'=>'_blank']); ?>                                                                                                                        
