                    ...
                    <div class="card-header">
                        <?= $this->Form->create('search') ?>                        
                            ...
                            <!--<div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons" align="text-right">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions text-nowrap">                                        
                                        ...
                                        <?php if ($user_role == 'admin' || $user_role == 'individual' || $user_role == 'loja' ) :?>
