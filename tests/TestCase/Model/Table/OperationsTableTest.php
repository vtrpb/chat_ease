...
class OperationsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Operations') ? [] : ['className' => OperationsTable::class];
        $this->Operations = TableRegistry::getTableLocator()->get('Operations', $config);
    }
